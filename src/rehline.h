...
public:
    ReHLineLinearSolver(ConstRefMat X, ConstRefMat U, ConstRefMat V,
                  ConstRefMat S, ConstRefMat T, ConstRefMat Tau,
...
{
    // Create solver
    ReHLineLinearSolver<typename DerivedMat::PlainObject, Index> solver(X, U, V, S, T, Tau, A, b, mu);
